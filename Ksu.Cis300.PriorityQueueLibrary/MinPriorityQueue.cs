    ...
    public class MinPriorityQueue<TPriority, TValue> where TPriority : IComparable<TPriority>
    {
            ...
            LeftistTree<KeyValuePair<TPriority, TValue>> h2)
        {
            ...
            else
            {
                ...
                LeftistTree<KeyValuePair<TPriority, TValue>> temp;
                if (compare < 0)
                {
                    temp = new LeftistTree<KeyValuePair<TPriority, TValue>>(h1.Data, h1.LeftChild, Merge(h1.RightChild, h2));
                }
                else
                {
                    temp = new LeftistTree<KeyValuePair<TPriority, TValue>>(h2.Data, h2.LeftChild, Merge(h2.RightChild, h1));
                }
                return temp;
            }
        }
        ...
        /// <summary>
        /// gets the priority stored in the root 
        /// of the leftist heap
        /// </summary>
        ...
        /// <summary>
        /// removes the element with min priority
